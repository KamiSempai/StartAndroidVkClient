package ru.startandroid.vkclient.auth;
...
import ru.startandroid.vkclient.MainActivity;
...
public class LoginActivity extends Activity {
    ...
    private static final String[] scope = {VKScope.MESSAGES,VKScope.FRIENDS,VKScope.PHOTOS};
